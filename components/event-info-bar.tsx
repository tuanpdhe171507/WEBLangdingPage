        ...
        <div className="relative z-30 max-w-6xl mx-auto px-6">
            <div className="absolute top-0 left-6 right-6 -translate-y-1/2">
                <motion.div
                    ...
                    className="bg-[#1D6E58] rounded-2xl md:rounded-full shadow-[0_15px_40px_rgba(0,0,0,0.2)] border border-white/10 flex flex-wrap items-center justify-between px-4 py-2 md:px-8"
                >
                    {/* Start Date */}
